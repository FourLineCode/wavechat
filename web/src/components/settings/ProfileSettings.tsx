      ...
      <Formik
        ...
        onSubmit={async (values) => {
          ...
          const input: UpdateUserInput = {
            displayName: values.displayName !== user?.displayName ? values.displayName : undefined,
            bio: values.bio !== user?.bio ? values.bio : undefined,
            avatarUrl: values.avatarUrl !== user?.avatarUrl ? values.avatarUrl : undefined,
            university: values.university !== user?.university ? values.university : undefined,
            department: values.department !== user?.department ? values.department : undefined,
        ...
        <Form className="space-y-2.5">
          <div className="flex">
            <div className="flex-1 space-y-2.5">
              <Input disabled name="username" label="Username" placeholder="Username" />
              <Input
                disabled={loading}
                name="displayName"
                label="Display Name"
