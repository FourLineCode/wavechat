          ...
          <div className="flex justify-end px-2">
            ...
            <Modal {...declineRequestModal}>
              ...
              <div className="mt-2 text-sm">
                All the current pending requests will be declined and this action is not reversible.
                Click <b>Confirm</b> to decline all requests.
              </div>
              <div className="flex justify-center mt-4 space-x-4">
                <Button variant="outlined" onClick={declineRequestModal.onClose}>
                  Cancel
                </Button>
                <Button type="submit" onClick={declineAll} isSubmitting={declineAllLoading}>
                  Confirm
                </Button>
              </div>
            </Modal>
