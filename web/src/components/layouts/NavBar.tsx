    ...
    <div className="flex justify-between w-full h-16 px-16 pt-12 lg:px-48">
      <Link passHref href="/">
        <div className="flex items-center cursor-pointer">
          ...
          <div className="uppercase bg-brand-500 rounded-md py-0.5 px-1 ml-2 text-xs">BETA</div>
        </div>
      </Link>
      ...
      <Modal large {...aboutModal} className="overflow-y-auto">
        ...
        <div className="space-y-2">
          <div>
            WaveChat is a real time social media application made for college/university students.
            In the recent couple years, the covid-19 pandemic has changed how students of all level
            interact with each other. It has been really tough for students to meet new people and
            make friends over the internet. This app was made for students to find other students of
            similar interest and make new friends. It also makes it easy for students of a certain
            course or section to communicate with each other about their activities and help each
            other.
          </div>
          <div>
            ...
            <a target="_blank" className="text-brand-500 hover:underline" href="https://ewubd.edu">
              East West University
            </a>
            . This is an open source project as of right now. You can find out more about this
